...
from services.authorization.models.edit_user_dto import EditUserDto
...
class TestChangeUserData:
    ...
    def test_register_user_change_user_data(self, verified, banned, super_admin_auth_api_service,
                                            anonymous_user_auth_api_service, register_user):
        ...
        editing_response = super_admin_auth_api_service.patch_user(user_id=registered_user.user.id,
