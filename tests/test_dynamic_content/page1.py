...
class Page1(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.image_1 = ImageElement(driver, self.IMG_1_LOC, attribute='src')
        self.image_2 = ImageElement(driver, self.IMG_2_LOC, attribute='src')
        self.image_3 = ImageElement(driver, self.IMG_3_LOC, attribute='src')